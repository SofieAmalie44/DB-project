...
from .mongo_views.character_view import MongoCharacterList, MongoCharacterDetail
...
from .mongo_views.inventory_view import MongoInventoryList, MongoInventoryDetail
